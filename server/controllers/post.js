...
const createNewPost = async (req, res) => {
  try {
    ...
    const query =
      'INSERT INTO posts (caption, posted_by, posted_on) VALUES ($1, $2, $3) RETURNING *'
    const values = [caption, userId, Date.now()]
    ...
    console.error(err);
    return res.status(500).json({ message: 'Failed to post. There was an error.' + err })
  }
}
